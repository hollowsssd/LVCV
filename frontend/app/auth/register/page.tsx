      ...
      <div className="min-h-[72vh] flex items-center justify-center px-4">
        <div className="w-full max-w-xl space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-slate-500">Chọn vai trò → nhập thông tin → tạo tài khoản.</p>

            <div className="mx-auto mt-3 flex w-fit items-center gap-2 rounded-full border border-slate-200 bg-white/80 px-3 py-1 text-[11px] text-slate-600">
            ...
            <div className="space-y-2">
                ...
                <button
                  ...
                  className={[
                    ...
                    role === "employer"
                      ? "border-slate-900 bg-slate-900 text-white"
                      : "border-slate-200 bg-white hover:border-slate-900",
                    roleLocked && role !== "employer" ? "opacity-50 cursor-not-allowed" : "",
                  ].join(" ")}
                >
                  <div className="text-sm font-semibold">🏢 Nhà tuyển dụng</div>
                  <div className={`text-xs mt-1 ${role === "employer" ? "text-slate-200" : "text-slate-500"}`}>
              ...
              {step === 1 ? (
                ...
                <div className="pt-2 flex items-center justify-between">
                  ...
                  <span className="text-[11px] text-slate-500">Vai trò đã khóa. Muốn đổi hãy “Quay lại”.</span>
                </div>
              )}
            </div>
                ...
                {role === "candidate" ? (
                  <div className="rounded-2xl border border-slate-200 bg-slate-50/60 p-4 space-y-4">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1 sm:col-span-2">
                        <label className="text-sm font-medium text-slate-700">Tóm tắt</label>
                        <textarea
                          value={summary}
                          onChange={(e) => setSummary(e.target.value)}
                          rows={3}
                          className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-slate-900 resize-none"
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50/60 p-4 space-y-4">
                    <div className="flex items-center justify-between">
                      <p className="text-sm font-semibold text-slate-900">Thông tin nhà tuyển dụng</p>
                    </div>
